...
void main() async {
  ...
  runApp(
    EasyLocalization(
      ...
      path: 'lib/language', // Use your actual path for language assets
      fallbackLocale: const Locale('en'),
      child: const FedisApp(),
    ),
  );
}

class FedisApp extends StatelessWidget {
  const FedisApp({super.key});
    ...
    return MultiProvider(
      ...
      child: Consumer<DarkModeProvider>(
        builder: (context, darkModeProvider, child) {
          return MaterialApp(
            title: 'appTitle'.tr(), // Use tr() for the app title
